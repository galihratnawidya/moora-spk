  ...
  <section id="container">
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        ?>
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><a href="index.php?module=home"><img src="img/pak_jaki.jpg" class="img-circle" width="80"></a></p>
        ...
        <div class="row">
          <div class="col-lg-12 main-chart" style="padding-left: 50px;padding-right: 50px;">
            ...
            <div class="border-head">
              <h3>BEASISWA SD NEGERI 1 KUDU</h3>
              <h5>Jl. Supriyadi No. 59, Kec. Kertosono, Kab. Nganjuk</h3>
            </div>
            <?php
    ...
    <footer class="site-footer" style="margin-top: 40vh;">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>SD Negeri 1 Kudu</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
